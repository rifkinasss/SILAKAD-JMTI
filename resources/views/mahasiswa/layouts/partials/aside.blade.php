    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="permohonan-data">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ url('permohonan/data-tugas-akhir') }}">Data Tugas
                            Akhir</a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="{{ url('permohonan/data-mata-kuliah') }}">Data Mata
                            Kuliah</a>
                    </li>
                </ul>
            </div>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="keterangan">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ url('keterangan/telah-tugas-akhir') }}">Telah
                            Tugas Akhir</a>
                    </li>
                </ul>
            </div>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="rekomendasi">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ url('rekomendasi/beasiswa') }}">Beasiswa</a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="{{ url('rekomendasi/lomba') }}">Lomba</a>
                    </li>
                </ul>
            </div>
        </li>
