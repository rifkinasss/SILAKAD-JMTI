            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-sample" method="POST" action="{{ route('StoreRekBeasiswa') }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="semester" required>
                                                ...
                                                <option value="6 ( Enam )">
                                                    Semester 6</option>
                                                <option value="7 ( Tujuh )">
                                                    Semester 7</option>
                                                <option value="8 ( Delapan )">
                                                    Semester 8</option>
                                                <option value="9 ( Sembilan )">
                                                    Semester 9</option>
                                                <option value="10 ( Sepuluh )">
                                                    Semester 10</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <p class="card-description">* Contoh : 4,00</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" name="sks_tempuh"
                                                value="{{ Auth::user()->sks_tempuh }}" required maxlength="3" />
                                            <p class="card-description">* Contoh : 100</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" rows="4" class="form-control" name="alamat_perusahaan" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
