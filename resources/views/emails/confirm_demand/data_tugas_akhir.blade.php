    ...
    <div class="container">
        ...
        <div class="content">
            <div class="header-content">
                <h2>Permohonan Data Tugas Akhir</h2>
            </div>
            <p>
                Mahasiswa <b>{{ $dataTugasAkhir->user->nama_lengkap }}</b> telah mengajukan permohonan data tugas akhir
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
                <tbody>
                    <tr>
                        ...
                        <td style="padding: 10px; text-align: left;">{{ $dataTugasAkhir->user->nama_lengkap }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; text-align: left; font-weight: bold;">NIM</td>
                        <td style="padding: 10px; text-align: left;">{{ $dataTugasAkhir->user->nim }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; text-align: left; font-weight: bold;">No HP</td>
                        <td style="padding: 10px; text-align: left;">{{ $dataTugasAkhir->user->no_hp }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; text-align: left; font-weight: bold;">Program Studi</td>
                        <td style="padding: 10px; text-align: left;">{{ $dataTugasAkhir->user->program_studi }}
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; text-align: left; font-weight: bold;">Nama Mitra</td>
                        <td style="padding: 10px; text-align: left;">{{ $dataTugasAkhir->nama_mitra }}
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; text-align: left; font-weight: bold;">Alamat Mitra</td>
                        <td style="padding: 10px; text-align: left;">{{ $dataTugasAkhir->alamat_mitra }}
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; text-align: left; font-weight: bold;">Periode Pelaksanaan</td>
                        <td style="padding: 10px; text-align: left;">
                            {{ Carbon::parse($dataTugasAkhir->tgl_mulai)->format('d F') }} -
                            {{ Carbon::parse($dataTugasAkhir->tgl_akhir)->format('d F Y') }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; text-align: left; font-weight: bold;">Judul Tugas Akhir</td>
                        <td style="padding: 10px; text-align: left;">{{ $dataTugasAkhir->judul_tugas_akhir }}
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; text-align: left; font-weight: bold;">Dosen Pembimbing</td>
                        <td style="padding: 10px; text-align: left;">{{ $dataTugasAkhir->dosen_pembimbing }}
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; text-align: left; font-weight: bold;">Data yang di butuhkan</td>
                        <td style="padding: 10px; text-align: left;">{{ $dataTugasAkhir->data_yang_dibutuhkan }}
                        </td>
                    </tr>
                </tbody>
            </table>
