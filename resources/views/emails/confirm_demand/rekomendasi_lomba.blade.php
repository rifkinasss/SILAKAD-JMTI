    ...
    <div class="container">
        ...
        <div class="content">
            <div class="header-content">
                <h2>Rekomendasi Lomba</h2>
            </div>
            <p>
                Mahasiswa <b>{{ $rekomendasilomba->user->nama_lengkap }}</b> telah mengajukan rekomendasi lomba
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
                <tbody>
                    <tr>
                        ...
                        <td style="padding: 10px; text-align: left;">{{ $rekomendasilomba->user->nama_lengkap }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; text-align: left; font-weight: bold;">NIM</td>
                        <td style="padding: 10px; text-align: left;">{{ $rekomendasilomba->user->nim }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; text-align: left; font-weight: bold;">Semester</td>
                        <td style="padding: 10px; text-align: left;">{{ $rekomendasilomba->user->semester }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; text-align: left; font-weight: bold;">Program Studi</td>
                        <td style="padding: 10px; text-align: left;">{{ $rekomendasilomba->user->program_studi }}
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; text-align: left; font-weight: bold;">IPK</td>
                        <td style="padding: 10px; text-align: left;">{{ $rekomendasilomba->user->ipk }}
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; text-align: left; font-weight: bold;">SKS Tempuh</td>
                        <td style="padding: 10px; text-align: left;">{{ $rekomendasilomba->user->sks_tempuh }}
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; text-align: left; font-weight: bold;">Nama Program</td>
                        <td style="padding: 10px; text-align: left;">{{ $rekomendasilomba->nama_program }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; text-align: left; font-weight: bold;">Nama Instansi</td>
                        <td style="padding: 10px; text-align: left;">{{ $rekomendasilomba->nama_perusahaan }}
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; text-align: left; font-weight: bold;">Alamat Instansi</td>
                        <td style="padding: 10px; text-align: left;">{{ $rekomendasilomba->alamat_perusahaan }}
                        </td>
                    </tr>
                </tbody>
            </table>
