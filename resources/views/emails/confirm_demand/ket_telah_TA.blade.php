    ...
    <div class="container">
        ...
        <div class="content">
            <div class="header-content">
                <h2>Keterangan Telah Tugas Akhir</h2>
            </div>
            <p>
                Mahasiswa <b>{{ $KetTelahTA->user->nama_lengkap }}</b> telah mengajukan keterangan telah tugas akhir
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
                <tbody>
                    <tr>
                        ...
                        <td style="padding: 10px; text-align: left;">{{ $KetTelahTA->user->nama_lengkap }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; text-align: left; font-weight: bold;">NIM</td>
                        <td style="padding: 10px; text-align: left;">{{ $KetTelahTA->user->nim }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; text-align: left; font-weight: bold;">Semester</td>
                        <td style="padding: 10px; text-align: left;">{{ $KetTelahTA->user->semester }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; text-align: left; font-weight: bold;">Program Studi</td>
                        <td style="padding: 10px; text-align: left;">{{ $KetTelahTA->user->program_studi }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; text-align: left; font-weight: bold;">Judul Tugas Akhir</td>
                        <td style="padding: 10px; text-align: left;">{{ $KetTelahTA->judul_tugas_akhir }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; text-align: left; font-weight: bold;">Dosen Pembimbing Utama</td>
                        <td style="padding: 10px; text-align: left;">{{ $KetTelahTA->nama_pembimbing_utama }}</td>
                    </tr>
                    <tr style="background-color: #f9f9f9;">
                        <td style="padding: 10px; text-align: left; font-weight: bold;">Dosen Pembimbing Pendamping</td>
                        <td style="padding: 10px; text-align: left;">{{ $KetTelahTA->nama_pembimbing_pendamping }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
