    ...
    <div class="container">
        ...
        <div class="content">
            <div class="header-content">
                <h2>Terima Kasih telah menggunakan Sistem Informasi Layanan Akademik JMTI</h2>
            </div>
            <p>
                Hai, {{ $user->nama_lengkap }}
            </p>
            <p>
                Pengajuan anda sudah kami terima dengan lama proses maksimal <strong>2x24
                    jam</strong> di hari kerja. Mohon untuk mengecek secara berkala status perubahan pada laman web.
            </p>

            <p><a class="button" href="{{ route('mahasiswa') }}">
                    Cek Status
                </a>
        </div>
        </p>
